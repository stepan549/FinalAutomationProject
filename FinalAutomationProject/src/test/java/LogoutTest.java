...
public class LogoutTest {
    ...
    private static final Logger logger = Logger.getLogger(LogoutTest.class);
    ...
    public void logoutTest() {
        ...
        MainPage mainPage = mailboxPage.clickLogoutLink();
        logger.info("Click logout link");
        Assert.assertTrue(mainPage.checkRegistrationLink());
    }
}
